...
function BX_EnableFileLog(filedir='/var/blog', filename=null, filemaxsize = null, filemaxcount = null) {
    var logOptions = {
        "rootFolder": filedir,
        "subFolder": ""
    };
...
var BX_LOG = blog.log;
var BX_DEBUG = blog.debug;
var BX_TRACE = blog.trace;
var BX_INFO = blog.info;
var BX_WARN = blog.warn;
var BX_ERROR = blog.error;
class TimeFormater {
    static init() {
